...
public class GetBatchReportResultType  implements java.io.Serializable {
    private org.openimmunizationsoftware.dqa.service.schema.BatchReportType batchReport;

    public GetBatchReportResultType() {
    }

    public GetBatchReportResultType(
           org.openimmunizationsoftware.dqa.service.schema.BatchReportType batchReport) {
     ...
     * @return batchReport
     */
    public org.openimmunizationsoftware.dqa.service.schema.BatchReportType getBatchReport() {
        return batchReport;
    }
     ...
     * @param batchReport
     */
    public void setBatchReport(org.openimmunizationsoftware.dqa.service.schema.BatchReportType batchReport) {
        this.batchReport = batchReport;
    }
