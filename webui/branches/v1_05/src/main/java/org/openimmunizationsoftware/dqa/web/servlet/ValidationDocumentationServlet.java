...
{
  private static final String EXAMPLE = "MSH|^~\\&|TCH ImmSys|Nathan's Dev Laptop|TxImmTrac|TxDSHS|20110510095220||VXU^V04|1305039140421.100000004|P|2.4|\r"
  ...
  private void printCss(PrintWriter out)
  {
    ...
    out.println("      p {width:700px; color:" + DARK + "; background:" + VERY_LIGHT
        + "; padding:6px; border-style:none; border-width:1px; border-color:" + LIGHT + "}");
