...
public class ReportSchedule implements java.io.Serializable
{
  ...
  public static final String[][] STATUSES = {
    ...
    {STATUS_WAITING, "Waiting for Trigger"},
  ...
  {
      {
          PERIOD_EVERY_2_MINS, "Every 2 minutes"
      },
      {
          PERIOD_EVERY_5_MINS, "Every 5 minutes"
      },
      {
          PERIOD_EVERY_10_MINS, "Every 10 minutes"
      },
      {
          PERIOD_EVERY_15_MINS, "Every 15 minutes"
      },
      {
          PERIOD_EVERY_20_MINS, "Every 20 minutes"
      },
      {
          PERIOD_EVERY_30_MINS, "Every 30 minutes"
      },
      {
          PERIOD_EVERY_40_MINS, "Every 40 minutes"
      },
      {
          PERIOD_EVERY_60_MINS, "Every 60 minutes"
      },
      {
          PERIOD_EVERY_DAY, "Every day"
      },
      {
          PERIOD_EVERY_WORKING_DAY, "Every working day"
      },
      {
          PERIOD_EVERY_SUNDAY, "Every Sunday"
      },
      {
          PERIOD_EVERY_MONDAY, "Every Monday"
      },
      {
          PERIOD_EVERY_TUESDAY, "Every Tuesday"
      },
      {
          PERIOD_EVERY_WEDNESDAY, "Every Wednesday"
      },
      {
          PERIOD_EVERY_THURSDAY, "Every Thursday"
      },
      {
          PERIOD_EVERY_FRIDAY, "Every Friday"
      },
      {
          PERIOD_EVERY_SATURDAY, "Every Saturday"
      },
      {
  ...
  public ReportSchedule(int profileId, Date dateStart, String method, String period, String location, String status, String name) {
    this.profileId = profileId;
    this.dateStart = dateStart;
    this.method = method;
    this.period = period;
