...
{
  private static GetBatchesHandler getBatchesHandler = null;

  public static GetBatchesHandler getInstance() {
    if (getBatchesHandler == null) {
    	getBatchesHandler = new GetBatchesHandler();
    }
    return getBatchesHandler;
  }
