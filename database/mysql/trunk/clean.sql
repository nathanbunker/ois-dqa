ALTER TABLE dqa_issue_found DROP FOREIGN KEY dqa_fk_issue_found4;
ALTER TABLE dqa_code_received DROP FOREIGN KEY dqa_fk_code_received1;
ALTER TABLE dqa_code_received DROP FOREIGN KEY dqa_fk_code_received2;
ALTER TABLE dqa_code_received DROP FOREIGN KEY dqa_fk_code_received3;
ALTER TABLE dqa_issue_found DROP FOREIGN KEY dqa_fk_issue_found4;
ALTER TABLE dqa_batch_code_received DROP FOREIGN KEY dqa_fk_batch_code_received2;
ALTER TABLE dqa_receive_queue DROP FOREIGN KEY dqa_fk_receive_queue2;
ALTER TABLE dqa_next_of_kin DROP FOREIGN KEY dqa_fk_next_of_kin1;
ALTER TABLE dqa_issue_found DROP FOREIGN KEY dqa_fk_issue_found1;
ALTER TABLE dqa_vaccination DROP FOREIGN KEY dqa_fk_vaccination2;
ALTER TABLE dqa_receive_queue DROP FOREIGN KEY dqa_fk_receive_queue1;
ALTER TABLE dqa_batch_issues DROP FOREIGN KEY dqa_fk_batch_issues1;
ALTER TABLE dqa_batch_actions DROP FOREIGN KEY dqa_fk_batch_actions1;
ALTER TABLE dqa_batch_code_received DROP FOREIGN KEY dqa_fk_batch_code_received1;
ALTER TABLE dqa_batch_vaccine_cvx DROP FOREIGN KEY dqa_fk_batch_vaccine_cvx1;
