...
public class TestVaccinationUpdateParserHL7 extends TestCase
{
  ...
  public void testCreateVaccinationUpdateMessage()
  {
    ...
    assertEquals("US", patient.getAddressCountry());
    assertEquals("COUNTY", patient.getAddressCountyParish());
    assertEquals("TX", patient.getAddressState());
    assertEquals("102 N BOW WOW TERRACE", patient.getAddressStreet());
    assertEquals("APT 103", patient.getAddressStreet2());
    assertEquals("P", patient.getAddressType());
...
//    assertEquals("A", patient.getAliasTypeCode());
    assertEquals("Y", patient.getBirthMuliple());
    assertEquals("5", patient.getBirthOrder());
    ...
    assertEquals("", nextOfKin.getAddressCountry());
    assertEquals("", nextOfKin.getAddressCountyParish());
    assertEquals("", nextOfKin.getAddressState());
    assertEquals("", nextOfKin.getAddressStreet());
    assertEquals("", nextOfKin.getAddressStreet2());
    assertEquals("", nextOfKin.getAddressType());
    ...
    assertEquals("", vaccination.getFacilityId());
