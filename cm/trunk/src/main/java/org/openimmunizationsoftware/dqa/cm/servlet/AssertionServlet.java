    ...
    try
    {
      ...
      if (assertionFieldIdString == null)
      {
        ...
        for (Object o : assertionDescriptionList)
        {
          ...
          {
            out.println("  <tr>");
            out.println("    <td width=\"400\"><a href=\"assertion?" + PARAM_ASSERTION_FIELD_ID + "=" + row[1] + "&" + PARAM_TEST_TYPE + "="
                + testType + "\">" + row[0] + "</a></td>");
      ...
      } else
      {
        ...
        out.println("<table>");
        out.println("  <caption>Assertion</caption>");
        out.println("  <tr>");
        ...
        for (AssertionIdentified assertionIdentified : assertionIdentifiedList)
        {
          ...
          String link = "testReport?" + TestReportServlet.PARAM_VIEW + "=" + URLEncoder.encode(assertionIdentified.getTestMessage().getTestSection().getTestSectionType(), "UTF-8") + 
              "&" + TestReportServlet.PARAM_TEST_MESSAGE_ID + "=" + assertionIdentified.getTestMessage().getTestMessageId();
          out.println("  <tr>");
