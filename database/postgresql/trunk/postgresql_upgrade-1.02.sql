ALTER TABLE dqa_message_received ADD message_key  VARCHAR(100);
...
--DID NOT DO--
INSERT INTO dqa_potential_issue_status (potential_issue_status_id, issue_id, profile_id, action_code, expect_min, expect_max) VALUES(NEXTVAL('dqa_potential_status_id_seq'), 485, 251, 'W', 0, 100);	
INSERT INTO dqa_potential_issue_status (potential_issue_status_id, issue_id, profile_id, action_code, expect_min, expect_max) VALUES(NEXTVAL('dqa_potential_status_id_seq'), 485, 252, 'W', 0, 100);	
INSERT INTO dqa_potential_issue_status (potential_issue_status_id, issue_id, profile_id, action_code, expect_min, expect_max) VALUES(NEXTVAL('dqa_potential_status_id_seq'), 485, 253, 'A', 0, 100);	
INSERT INTO dqa_potential_issue_status (potential_issue_status_id, issue_id, profile_id, action_code, expect_min, expect_max) VALUES(NEXTVAL('dqa_potential_status_id_seq'), 485, 254, 'A', 0, 100);	
INSERT INTO dqa_potential_issue_status (potential_issue_status_id, issue_id, profile_id, action_code, expect_min, expect_max) VALUES(NEXTVAL('dqa_potential_status_id_seq'), 485, 255, 'W', 0, 100);	
INSERT INTO dqa_potential_issue_status (potential_issue_status_id, issue_id, profile_id, action_code, expect_min, expect_max) VALUES(NEXTVAL('dqa_potential_status_id_seq'), 485, 256, 'W', 0, 100);	
INSERT INTO dqa_potential_issue_status (potential_issue_status_id, issue_id, profile_id, action_code, expect_min, expect_max) VALUES(NEXTVAL('dqa_potential_status_id_seq'), 485, 257, 'W', 0, 100);	
INSERT INTO dqa_potential_issue_status (potential_issue_status_id, issue_id, profile_id, action_code, expect_min, expect_max) VALUES(NEXTVAL('dqa_potential_status_id_seq'), 485, 258, 'A', 0, 100);
--END OF DID NOT DO--

INSERT INTO dqa_code_master(code_master_id, table_id, code_value, code_label, use_value, code_status) VALUES  (NEXTVAL('dqa_code_master_id_sequence'), 22, 'CHD', 'Child', 'CHD', 'V');
