...
public class GetMessageReceivedDetailsResultType  implements java.io.Serializable {
    private org.openimmunizationsoftware.dqa.service.schema.MessageReceivedDetailsType messageReceivedDetails;

    private org.openimmunizationsoftware.dqa.service.schema.IssueFoundType[] issueFoundList;

    public GetMessageReceivedDetailsResultType() {
    }

    public GetMessageReceivedDetailsResultType(
           org.openimmunizationsoftware.dqa.service.schema.MessageReceivedDetailsType messageReceivedDetails,
           org.openimmunizationsoftware.dqa.service.schema.IssueFoundType[] issueFoundList) {
     ...
     */
    public org.openimmunizationsoftware.dqa.service.schema.MessageReceivedDetailsType getMessageReceivedDetails() {
        return messageReceivedDetails;
    }
     ...
     */
    public void setMessageReceivedDetails(org.openimmunizationsoftware.dqa.service.schema.MessageReceivedDetailsType messageReceivedDetails) {
        this.messageReceivedDetails = messageReceivedDetails;
    }
     ...
     */
    public org.openimmunizationsoftware.dqa.service.schema.IssueFoundType[] getIssueFoundList() {
        return issueFoundList;
    }
     ...
     */
    public void setIssueFoundList(org.openimmunizationsoftware.dqa.service.schema.IssueFoundType[] issueFoundList) {
        this.issueFoundList = issueFoundList;
    }
    ...
    static {
        ...
        elemField.setNillable(false);
        elemField.setItemQName(new javax.xml.namespace.QName("http://dqaws.openimmunizationsoftware.org/dqa/schema", "issueFoundList"));
        typeDesc.addFieldDesc(elemField);
    }
