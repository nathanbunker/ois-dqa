...
public class GetNextOfKinListResultType  implements java.io.Serializable {
    private org.openimmunizationsoftware.dqa.service.schema.NextOfKinType[] nextOfKinList;

    public GetNextOfKinListResultType() {
    }

    public GetNextOfKinListResultType(
           org.openimmunizationsoftware.dqa.service.schema.NextOfKinType[] nextOfKinList) {
     ...
     */
    public org.openimmunizationsoftware.dqa.service.schema.NextOfKinType[] getNextOfKinList() {
        return nextOfKinList;
    }
     ...
     * @param nextOfKinList
     */
    public void setNextOfKinList(org.openimmunizationsoftware.dqa.service.schema.NextOfKinType[] nextOfKinList) {
        this.nextOfKinList = nextOfKinList;
    }
    ...
    static {
        ...
        elemField.setItemQName(new javax.xml.namespace.QName("http://dqaws.openimmunizationsoftware.org/dqa/schema", "nextOfKinList"));
