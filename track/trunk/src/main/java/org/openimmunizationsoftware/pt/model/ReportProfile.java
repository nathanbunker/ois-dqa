...
public class ReportProfile implements java.io.Serializable
{
  ...
  public ReportProfile(int profileId, Integer extendsProfileId, String profileLabel, String providerId, String username, String profileType,
      String useStatus, String extendStatus, String contextType, String selectorType, byte[] definition) {
    this.profileId = profileId;
