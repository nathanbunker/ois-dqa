...
public class GetCodeReceivedListResultType  implements java.io.Serializable {
    private org.openimmunizationsoftware.dqa.service.schema.CodeReceivedType[] codeReceivedList;

    public GetCodeReceivedListResultType() {
    }

    public GetCodeReceivedListResultType(
           org.openimmunizationsoftware.dqa.service.schema.CodeReceivedType[] codeReceivedList) {
     ...
     */
    public org.openimmunizationsoftware.dqa.service.schema.CodeReceivedType[] getCodeReceivedList() {
        return codeReceivedList;
    }
     ...
     */
    public void setCodeReceivedList(org.openimmunizationsoftware.dqa.service.schema.CodeReceivedType[] codeReceivedList) {
        this.codeReceivedList = codeReceivedList;
    }
    ...
    static {
        ...
        elemField.setItemQName(new javax.xml.namespace.QName("http://dqaws.openimmunizationsoftware.org/dqa/schema", "codeReceivedList"));
