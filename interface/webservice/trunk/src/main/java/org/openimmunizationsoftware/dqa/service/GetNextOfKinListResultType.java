...
public class GetNextOfKinListResultType  implements java.io.Serializable {
    private org.openimmunizationsoftware.dqa.service.NextOfKinType[] nextOfKinList;

    public GetNextOfKinListResultType() {
    }

    public GetNextOfKinListResultType(
           org.openimmunizationsoftware.dqa.service.NextOfKinType[] nextOfKinList) {
     ...
     */
    public org.openimmunizationsoftware.dqa.service.NextOfKinType[] getNextOfKinList() {
        return nextOfKinList;
    }
     ...
     * @param nextOfKinList
     */
    public void setNextOfKinList(org.openimmunizationsoftware.dqa.service.NextOfKinType[] nextOfKinList) {
        this.nextOfKinList = nextOfKinList;
    }
