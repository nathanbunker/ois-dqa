...
public class ManualServlet extends HttpServlet implements RecordServletInterface
{
  ...
  protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException
  {
    ...
    try
    {
      if (update != null)
      {
        doUpdate(req, dataSession, out);
      } else
      {
        doQuery(req, dataSession, out, querySelected);
      }
    } catch (Exception e)
    {
      e.printStackTrace();
  ...
  public void doQuery(HttpServletRequest req, Session dataSession, PrintWriter out, String querySelected) throws ParseException
  {
  ...
  public void doUpdate(HttpServletRequest req, Session dataSession, PrintWriter out) throws ParseException
  {
