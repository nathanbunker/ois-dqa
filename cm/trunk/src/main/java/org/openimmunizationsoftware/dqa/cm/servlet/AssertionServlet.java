...
public class AssertionServlet extends HomeServlet
{
  ...
  protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException
  {
    ...
    try
    {
      ...
      {
        printConformanceAssertionsForUpdate(req, dataSession, out, testType);
      } else
      {
        printConformanceAssertion(dataSession, out, assertionFieldIdString, testType);
      }
  ...
  public void printConformanceAssertion(Session dataSession, PrintWriter out, String assertionFieldIdString, String testType)
  ...
  public void printConformanceAssertionsForUpdate(HttpServletRequest req, Session dataSession, PrintWriter out, String testType)
  {
    ...
    out.println("  </tr>");
    @SuppressWarnings("unchecked")
    List<Object> assertionDescriptionList = query.list();
    for (Object o : assertionDescriptionList)
    {
      ...
      {
        out.println("  <tr>");
        out.println("    <td width=\"600\"><a href=\"assertion?" + PARAM_ASSERTION_FIELD_ID + "=" + row[1] + "&" + PARAM_TEST_TYPE + "=" + testType
            + "\">" + row[0] + "</a></td>");
