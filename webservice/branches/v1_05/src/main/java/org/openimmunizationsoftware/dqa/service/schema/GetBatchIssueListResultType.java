...
public class GetBatchIssueListResultType  implements java.io.Serializable {
    private org.openimmunizationsoftware.dqa.service.schema.BatchIssueType[] batchIssueList;

    public GetBatchIssueListResultType() {
    }

    public GetBatchIssueListResultType(
           org.openimmunizationsoftware.dqa.service.schema.BatchIssueType[] batchIssueList) {
     ...
     */
    public org.openimmunizationsoftware.dqa.service.schema.BatchIssueType[] getBatchIssueList() {
        return batchIssueList;
    }
     ...
     */
    public void setBatchIssueList(org.openimmunizationsoftware.dqa.service.schema.BatchIssueType[] batchIssueList) {
        this.batchIssueList = batchIssueList;
    }
    ...
    static {
        ...
        elemField.setItemQName(new javax.xml.namespace.QName("http://dqaws.openimmunizationsoftware.org/dqa/schema", "batchIssuesList"));
