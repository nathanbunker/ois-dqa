...
public class GetBatchResultType  implements java.io.Serializable {
    private org.openimmunizationsoftware.dqa.service.MessageBatchType messageBatch;

    public GetBatchResultType() {
    }

    public GetBatchResultType(
           org.openimmunizationsoftware.dqa.service.MessageBatchType messageBatch) {
     ...
     * @return messageBatch
     */
    public org.openimmunizationsoftware.dqa.service.MessageBatchType getMessageBatch() {
        return messageBatch;
    }
     ...
     * @param messageBatch
     */
    public void setMessageBatch(org.openimmunizationsoftware.dqa.service.MessageBatchType messageBatch) {
        this.messageBatch = messageBatch;
    }
