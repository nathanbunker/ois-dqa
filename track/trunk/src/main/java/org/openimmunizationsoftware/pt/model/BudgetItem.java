...
public class BudgetItem
{
  ...
  public static final String[][] ITEM_STATUS = { { ITEM_STATUS_MONTHLY, "Monthly" }, { ITEM_STATUS_YEARLY, "Yearly" },
      { ITEM_STATUS_SPORADIC, "Sporadic" }, { ITEM_STATUS_ONE_TIME, "One Time" }, { ITEM_STATUS_CLOSED, "Closed" } };
  ...
  public static final String[][] PRIORITY_CODE = { { PRIORITY_CODE_COMMITTED, "Committed" }, { PRIORITY_CODE_SCHEDULED, "Scheduled" },
      { PRIORITY_CODE_FLEXIBLE, "Flexible" }, { PRIORITY_CODE_DEBT_PAYOFF, "Debt Payoff" }, {PRIORITY_CODE_DONATIONS, "Donations"}, { PRIORITY_CODE_SAVINGS, "Savings" },
