...
public class GetBatchesResultType  implements java.io.Serializable {
    private org.openimmunizationsoftware.dqa.service.schema.MessageBatchType[] messageBatchList;

    public GetBatchesResultType() {
    }

    public GetBatchesResultType(
           org.openimmunizationsoftware.dqa.service.schema.MessageBatchType[] messageBatchList) {
     ...
     */
    public org.openimmunizationsoftware.dqa.service.schema.MessageBatchType[] getMessageBatchList() {
        return messageBatchList;
    }
     ...
     */
    public void setMessageBatchList(org.openimmunizationsoftware.dqa.service.schema.MessageBatchType[] messageBatchList) {
        this.messageBatchList = messageBatchList;
    }
    ...
    static {
        ...
        elemField.setItemQName(new javax.xml.namespace.QName("http://dqaws.openimmunizationsoftware.org/dqa/schema", "messageBatchList"));
