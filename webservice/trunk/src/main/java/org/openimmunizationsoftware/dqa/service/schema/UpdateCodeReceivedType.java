...
public class UpdateCodeReceivedType  implements java.io.Serializable {
    private org.openimmunizationsoftware.dqa.service.schema.CodeReceivedSmallType[] codeReceivedList;

    public UpdateCodeReceivedType() {
    }

    public UpdateCodeReceivedType(
           org.openimmunizationsoftware.dqa.service.schema.CodeReceivedSmallType[] codeReceivedList) {
     ...
     */
    public org.openimmunizationsoftware.dqa.service.schema.CodeReceivedSmallType[] getCodeReceivedList() {
        return codeReceivedList;
    }
     ...
     */
    public void setCodeReceivedList(org.openimmunizationsoftware.dqa.service.schema.CodeReceivedSmallType[] codeReceivedList) {
        this.codeReceivedList = codeReceivedList;
    }
    ...
    static {
        ...
        elemField.setItemQName(new javax.xml.namespace.QName("http://dqaws.openimmunizationsoftware.org/dqa/schema", "codeReceived"));
