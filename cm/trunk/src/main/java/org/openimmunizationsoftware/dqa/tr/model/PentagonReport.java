...
public class PentagonReport
{
  ...
  private int scoreUCMajorConflicts = -1;
  private int scoreUCConflicts = -1;
  private int scoreUCMajorConstraints = -1;
  private int scoreUCUnexpConstraints = -1;
  ...
  public int getScoreUCMajorConflicts()
  {
    return scoreUCMajorConflicts;
  }
  public void setScoreUCMajorConflicts(int scoreUCMajorConflicts)
  {
    this.scoreUCMajorConflicts = scoreUCMajorConflicts;
  }
  ...
  public int getScoreUCMajorConstraints()
  {
    return scoreUCMajorConstraints;
  }
  public void setScoreUCMajorConstraints(int scoreUCMajorConstraints)
  {
    this.scoreUCMajorConstraints = scoreUCMajorConstraints;
  }
  public int getScoreUCUnexpConstraints()
  {
    return scoreUCUnexpConstraints;
  }
  public void setScoreUCUnexpConstraints(int scoreUCUnexpConstraints)
  {
    this.scoreUCUnexpConstraints = scoreUCUnexpConstraints;
  }
